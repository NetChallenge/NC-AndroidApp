...
public class MyVoiceRippleView extends View implements TimerCircleRippleRenderer.TimerRendererListener {
    ...
    private RawAudioStream recorder;
    ...
    public MyVoiceRippleView(Context context) {
        super(context);
        init(context, null);
    }

    public MyVoiceRippleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyVoiceRippleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, info.kimjihyok.ripplelibrary.R.styleable.VoiceRippleView, 0, 0);
        try {
            rippleRadius = a.getInt(info.kimjihyok.ripplelibrary.R.styleable.VoiceRippleView_VoiceRippleView_rippleRadius, MIN_RADIUS);
            iconSize = a.getInt(info.kimjihyok.ripplelibrary.R.styleable.VoiceRippleView_VoiceRippleView_iconSize, MIN_ICON_SIZE);
        } finally {
            a.recycle();
        }
    ...
    public void setMediaRecorder(RawAudioStream recorder) {
